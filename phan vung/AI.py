...
import cv2
import imutils
rtsp = 'rtsp://admin:Admin123@192.168.32.204/cam/realmonitor?channel=1&subtype=00&authbasic=YWRtaW46QWRtaW4xMjM='
rtsp2 = 'rtsp://admin:Admin123@192.168.32.202:554/Streaming/Channels/101'
# Tham số đầu vào
ap = argparse.ArgumentParser()
ap.add_argument("-v", "--video", help="Nguồn video mặc định 0 là sử dụng webcam", default='0', type=str)
ap.add_argument("-a", "--min-area", type=int, default=250, help="Kích thước nhỏ nhất của đối tượng")
...
top_left, bottom_right = (165, 130), (200, 30)
